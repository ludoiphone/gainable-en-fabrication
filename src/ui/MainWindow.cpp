      ...
      m_pac(pac)
{
    ...
    m_wallpaper->setPixmap(
        QPixmap("/home/ludo/Desktop/test4/images/mainWindow.jpg")
        .scaled(size(), Qt::KeepAspectRatioByExpanding, Qt::SmoothTransformation)
    );
    m_wallpaper->lower();

    // ===================== Bandeau NEWS tout en haut =====================
    ...
    // ===================== Photos ======================
    m_photos = new Photos("/home/ludo/Desktop/test4/photos", this);
    m_photos->setGeometry(600, 100, 400, 400);
    m_photos->show();
