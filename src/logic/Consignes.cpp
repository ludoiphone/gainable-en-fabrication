...
void Consignes::chargerDefaut() {
    ...
    m_consignes["ConsigneGrandeVitesseExterieurChauffage"] = -2.0;
    ...
    m_consignes["ConsigneGrandeVitesseInterieurFroid"] = 23.0;
    m_consignes["ConsigneDepartVentilateurInterieurChauffage"] = 35.0;
    m_consignes["ConsigneDegivrageFroid"] = -3.0;
    m_consignes["ConsigneFinDegivrageFroid"] = 15.0;
    m_consignes["ConsigneVentilationInterieurCanicule"] = 20.0;
    m_consignes["ConsigneProtectionHautePression"] = 60.0;
}
