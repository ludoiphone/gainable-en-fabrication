      ...
      currentIndex(-1)
{
    ...
    m_background->setPixmap(QPixmap("/home/ludo/Desktop/Gainable/images/modifCons.jpg"));
    m_background->setGeometry(0, 0, 1024, 600);
    m_background->lower();

    // --- Initialisation des consignes ---
    m_modifConsignes.reset(new Consignes("/home/ludo/Desktop/Gainable/config/consignes.ini"));
    ...
    addConfig("Grande Vitesse Ext Chauffage", "ConsigneGrandeVitesseExterieurChauffage", -5.0, 1.0, -2.0);
    ...
    m_groupBox->setTitle("");
    m_groupBox->setGeometry(573, 200, 419, 200);//573, 200
