    ...
    : QWidget(parent), m_pac(pac)
{
    ...
    // ----- CHARGEMENT FONTS -----
    int fontId = QFontDatabase::addApplicationFont("/home/ludo/Desktop/Gainable/fonts/digital-7.ttf");
    QFont digitalFont;
    if (fontId != -1) {
    ...
    qDebug() << "[UI] TemperatureWidget initialisé (mode autonome, style original)";
}
