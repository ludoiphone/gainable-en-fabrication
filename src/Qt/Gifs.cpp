...
Gifs::~Gifs()
{
    ...
    auto movies = { m_ventExtMovie, m_ventIntMovie, m_vitesseVent1MovieExt, m_vitesseVent1MovieInt,
                    ...
                    m_compresseurChauffageMovie, m_caniculeMovie, m_degivrageMovie, m_egouttageMovie };
    ...
    auto labels = { m_ventExtLabel, m_ventIntLabel, m_vitesseVent1LabelExt, m_vitesseVent1LabelInt,
                    ...
                    m_compresseurChauffageLabel, m_caniculeLabel, m_degivrageLabel, m_egouttageLabel };
...
void Gifs::setup()
{
    ...
    createGif("chauffage.gif",       m_compresseurChauffageLabel, m_compresseurChauffageMovie, QRect(610, 480, 100, 100));
    createGif("canicule.gif",        m_caniculeLabel,         m_caniculeMovie,          QRect(170, 480, 120,120));
...
void Gifs::updateGifs()
{
    ...
    bool actifCa = m_pac->getCanicule();
    ...
    } else if (mode == MODE_CANICULE) {
        m_caniculeLabel->setVisible(actifCa);
        actifCa ? m_caniculeMovie->start() : m_caniculeMovie->stop();
        m_compresseurFroidLabel->setVisible(actifComp);
        actifComp ? m_compresseurFroidMovie->start() : m_compresseurFroidMovie->stop();
    } else {
        m_compresseurFroidLabel->hide();
