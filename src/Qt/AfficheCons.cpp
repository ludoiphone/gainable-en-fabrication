...
AfficheCons::AfficheCons(QWidget *parent)
    : QWidget(parent)
{
    m_configCons.reset(new Consignes("/home/ludo/Desktop/Gainable/config/consignes.ini"));
    m_configCons->update();
    ...
    QPixmap bg("/home/ludo/Desktop/Gainable/images/afficheCons.jpg");
    ...
    // --- Fonts ---
    int id = QFontDatabase::addApplicationFont("/home/ludo/Desktop/Gainable/fonts/digital-7.ttf");
    QString family;
    if (id != -1) {
    ...
    int idTitre = QFontDatabase::addApplicationFont("/home/ludo/Desktop/Gainable/fonts/Coolvetica.ttf");
    QString titleFamily;
    if (idTitre != -1) {
