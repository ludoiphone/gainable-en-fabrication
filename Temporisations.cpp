...
void Temporisations::chargerDefaut() {
    m_temporisations["tempoStabilisationSondes"] = 7; // 7 secondes
    m_temporisations["tempoVolets"] = 15; // 15 secondes
    m_temporisations["tempoComp"] = 18; // 3 minutes
    m_temporisations["tempoDepartDegCh"] = 2400; // 40 minutes
    m_temporisations["tempoFinDegCh"] = 60; // 10 minutes
    m_temporisations["tempoEgouttage"] = 60; // 1 minute
    m_temporisations["tempoV4V"] = 6; // 1 minute
    m_temporisations["tempoFinDegFr"] = 12; // 
}
